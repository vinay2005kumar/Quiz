...
const CollegeSettings = () => {
  ...
  const handleYearSemSubmit = async () => {
    try {
      if (!yearSemFormData.department || !yearSemFormData.year || yearSemFormData.semesters.length === 0) {
        showError('Please fill in all required fields');
        return;
      }
        ...
        >
          ...
          <DialogContent>
            <Box sx={{ mt: 2 }}>
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  value={yearSemFormData.department}
          ...
          <DialogActions>
            ...
            <Button
              ...
              disabled={!yearSemFormData.department || !yearSemFormData.year || yearSemFormData.semesters.length === 0}
            >
